    ...
    constructor(props) {
        ...
        this.state = {
            jobs: [
                ...
                { id: 2, naziv: "Instruktor vožnje B kategorije (M/Ž)", opis: "Auto Škola Lecon raspisuje javni poziv za prijavu instruktora vožnje B kategorije.", uvjeti: ["završena srednja stručna sprema", "posjedovanje dozvole instruktora vožnje A,B kategorije", "poznavanje engleskog jezika"], mjesto: "Travnik" },
                ...
                { id: 5, naziv: "Instruktor vožnje B kategorije (M/Ž)", opis: "Auto Škola Lecon raspisuje javni poziv za prijavu instruktora vožnje B kategorije.", uvjeti: ["završena srednja stručna sprema", "posjedovanje dozvole instruktora vožnje A,B kategorije", "poznavanje engleskog jezika"], mjesto: "Sarajevo" },
                { id: 6, naziv: "Instruktor vožnje B kategorije (M/Ž)", opis: "Auto Škola Lecon raspisuje javni poziv za prijavu instruktora vožnje B kategorije.", uvjeti: ["završena srednja stručna sprema", "posjedovanje dozvole instruktora vožnje A,B kategorije", "poznavanje engleskog jezika"], mjesto: "Sarajevo" },
                { id: 7, naziv: "Instruktor vožnje B kategorije (M/Ž)", opis: "Auto Škola Lecon raspisuje javni poziv za prijavu instruktora vožnje B kategorije.", uvjeti: ["završena srednja stručna sprema", "posjedovanje dozvole instruktora vožnje A,B kategorije", "poznavanje engleskog jezika"], mjesto: "Zenica" },
                { id: 8, naziv: "Instruktor vožnje B kategorije (M/Ž)", opis: "Auto Škola Lecon raspisuje javni poziv za prijavu instruktora vožnje B kategorije.", uvjeti: ["završena srednja stručna sprema", "posjedovanje dozvole instruktora vožnje A,B kategorije", "poznavanje engleskog jezika"], mjesto: "Sarajevo" }
